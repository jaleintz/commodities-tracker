...
async function importHousePriceData() {
  try {
    ...
    if (data.observations && data.observations.length > 0) {
      ...
      console.log(`✓ Saved data to FRED_HousePrice.JSON`);

      // Delete all existing ASPUS records from the table
      console.log('Clearing existing ASPUS data from fred_house_price_tb...');
      ...
      console.log('✓ Successfully cleared existing ASPUS data');
