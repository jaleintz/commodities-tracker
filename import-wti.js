...
async function importWTIData() {
  try {
    ...
    if (data.observations && data.observations.length > 0) {
      ...
      console.log(`✓ Saved data to FRED_WTI.JSON`);

      // Delete all existing DCOILWTICO records from the table
      console.log('Clearing existing DCOILWTICO data from fred_wti_tb...');
      ...
      console.log('✓ Successfully cleared existing DCOILWTICO data');
