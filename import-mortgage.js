...
async function importMortgageData() {
  try {
    ...
    if (data.observations && data.observations.length > 0) {
      ...
      console.log(`✓ Saved data to FRED_Mortgage.JSON`);

      // Delete all existing MORTGAGE30US records from the table
      console.log('Clearing existing MORTGAGE30US data from fred_mortgage_tb...');
      ...
      console.log('✓ Successfully cleared existing MORTGAGE30US data');
